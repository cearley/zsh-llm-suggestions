...
class TestOpenAIIntegration(unittest.TestCase):
    ...
    def test_generate_simple_command(self):
        ...
        self.assertTrue(any(cmd in output.lower() for cmd in ['ls', 'dir', 'find']), 
    ...
    def test_explain_command(self):
        ...
        self.assertTrue(any(word in output.lower() for word in ['list', 'files', 'directory', 'long', 'format']), 
    ...
    def test_command_with_markdown_response(self):
        ...
        self.assertTrue(any(cmd in output.lower() for cmd in ['find', 'locate', 'ls']), 
    ...
    def test_rate_limiting_handling(self):
        ...
        for i in range(3):
            ...
            if process.returncode != 0:
                ...
                self.assertTrue(len(process.stdout) > 0 or len(process.stderr) > 0,
